...
public class Main {
    ...
    public Data dataAslab = new Data();
    ...
    public void read() {
        if(Eric07238_dataSiswa.size() > 0) {
            for (int i = 0; i < Eric07238_dataSiswa.size(); i++) {
                ...
                System.out.println("Nama: " + Eric07238_dataSiswa.get(i).getNama());
                System.out.println("NIS: " + Eric07238_dataSiswa.get(i).getNIS());
                System.out.print("Kelas: " + Eric07238_dataSiswa.get(i).getKelas());
                System.out.print(" [" + Eric07238_dataSiswa.get(i).cekTipe(Eric07238_dataSiswa.get(i).getKelas()) + "]\n");
                System.out.println("Aslab: " + dataAslab.cekAslab(Eric07238_dataSiswa.get(i).getKelas()));
                System.out.println("--------------------");
            }
        } else {
